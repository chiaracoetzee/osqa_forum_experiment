...
class EdXAuthConsumer(OpenIdAbstractAuthConsumer):
    def get_user_url(self, request):
        return 'https://openid.edx.org/openid/provider/login/'

class EdXAuthContext(ConsumerTemplateContext):
    mode = 'BIGICON'
    type = 'DIRECT'
    weight = 200
    human_name = 'edX'
    icon = '/media/images/openid/edx.gif'
